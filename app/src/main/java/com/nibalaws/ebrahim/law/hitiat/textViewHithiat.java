...
public class textViewHithiat extends Activity implements GestureOverlayView.OnGesturePerformedListener {
...
//            relativeLayout.setOnTouchListener(gestureListener);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.homeclick:
                startActivity(new Intent(textViewHithiat.this, HomeActivity.class));
                break;
            case R.id.backclik:
                finish();
                break;
